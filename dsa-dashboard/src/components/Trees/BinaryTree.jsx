      ...
      <div className="flex flex-col items-center">
        <div
          className={`w-16 h-16 flex items-center justify-center rounded text-white font-bold shadow-md transition-all duration-300 mb-4
            ${node.value === highlightedNode ? 'bg-pink-300 animate-pulse' : 'bg-slate-400'}`}
        >
          {node.value}
        </div>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        ...
        {isDefinitionOpen && (
          <div className="mt-4 p-4 bg-white rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-slate-700 mb-2">What is a Binary Tree?</h3>
            ...
            <h3 className="text-lg font-semibold text-slate-700 mt-4 mb-2">Types of Binary Trees:</h3>
            ...
            <h3 className="text-lg font-semibold text-slate-700 mt-4 mb-2">Tree Traversal Methods:</h3>
            <ul className="list-disc list-inside text-gray-700">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        <h2 className="text-2xl font-semibold mb-4 text-slate-600">Binary Search Tree</h2>
        {error && (
