                ...
                <div
                  className={`w-20 h-20 rounded-lg shadow-lg flex items-center justify-center text-2xl font-bold transition-all duration-500
                    ${index === foundIndex ? 'bg-slate-500 text-white' :
                      ...
                      index < animationStep ? 'bg-slate-200 text-slate-700' :
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-8">
        ...
        {isDefinitionOpen && (
          <div className="mt-4 p-4 bg-white rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-slate-700 mb-2">What is Linear Search?</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-slate-600">Linear Search</h2>
          {error && (
