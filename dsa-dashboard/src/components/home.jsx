...
export default function Home() {
  const sections = [
    ...
    },
    {
      ...
      icon: '🔄',
      items: [
        { name: 'Bubble Sort', path: '/sort/bubble', description: 'Simple comparison-based sorting' },
        { name: 'Quick Sort', path: '/sort/quick', description: 'Efficient divide-and-conquer sorting' }
      ]
    },
    {
    ...
    },
    {
      ...
      icon: '🌳',
      items: [
        { name: 'Binary Tree', path: '/tree', description: 'Hierarchical data structure' },
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="text-center mb-16">
        <h1 className="text-5xl font-bold text-slate-600 mb-6 tracking-tight">
            ...
            <div className="p-6 space-y-4">
              {section.items.map((item, itemIndex) => (
                <Link
                  key={itemIndex}
                  to={item.path}
                  className="block p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-all duration-300 transform hover:translate-x-2"
                >
                  <h3 className="text-lg font-medium text-slate-700 mb-2">{item.name}</h3>
      ...
      <div className="bg-gradient-to-r from-slate-600 to-slate-500 rounded-xl p-8 text-white shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
            ...
            <p className="text-slate-100">Comprehensive definitions and step-by-step breakdowns</p>
          </div>
          <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
            <h3 className="font-semibold mb-2">🎯 Interactive Visualizations</h3>
            <p className="text-slate-100">Real-time demonstrations of algorithms in action</p>
          </div>
          <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
            <h3 className="font-semibold mb-2">⚡ Performance Analysis</h3>
            <p className="text-slate-100">Time and space complexity breakdowns</p>
          </div>
          <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
            <h3 className="font-semibold mb-2">🔍 Step-by-Step Guide</h3>
            <p className="text-slate-100">Detailed walkthroughs of each algorithm</p>
          </div>
          <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
            <h3 className="font-semibold mb-2">💡 Use Cases</h3>
            <p className="text-slate-100">Real-world applications and examples</p>
          </div>
          <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
            <h3 className="font-semibold mb-2">📊 Complexity Analysis</h3>
            <p className="text-slate-100">Best, worst, and average case scenarios</p>
          </div>
        </div>
      </div>
    </div>
