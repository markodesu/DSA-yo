                ...
                <div
                  className={`w-20 h-24 rounded-lg shadow-lg flex items-center justify-center text-xl font-bold transition-all duration-500
                    ${index === highlightIndices[0] || index === highlightIndices[1] ? 'bg-pink-300 text-white' :
                      sorted ? 'bg-slate-500 text-white' :
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-8">
        ...
        {isDefinitionOpen && (
          <div className="mt-4 p-4 bg-white rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-slate-700 mb-2">What is Bubble Sort?</h3>
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-slate-600">Bubble Sort</h2>
          {error && (
